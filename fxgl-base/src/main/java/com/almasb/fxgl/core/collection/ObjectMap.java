...
public class ObjectMap<K, V> implements Iterable<ObjectMap.Entry<K, V>>, Serializable {
    ...
    public ObjectMap(int initialCapacity, float loadFactor) {
        ...
        initialCapacity = FXGLMath.nextPowerOfTwo((int) Math.ceil(initialCapacity / loadFactor));
    ...
    public void ensureCapacity(int additionalCapacity) {
        ...
        if (sizeNeeded >= threshold) resize(FXGLMath.nextPowerOfTwo((int) Math.ceil(sizeNeeded / loadFactor)));
    }
